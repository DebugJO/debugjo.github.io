    ...
    {  
        ...
        {  
            ...
            {  
                ...
                {  
                    FileName = $"${{basedir}}/AppLogs/${{date:format=yyyyMM}}/${{date:format=dd}}/{folder}_${{date:format=yyyyMMdd}}.txt",  
                    Layout = layout,  
                    KeepFileOpen = true,  
                    MaxArchiveDays = 90  
                };  
...
{  
    ...
    {  
        ...
        string fileName = $"{log_folder}/{level.Name}_${{date:format=yyyyMMdd}}.txt";  
  
        FileTarget fileTarget = new($"{level.Name}File")  
        {  
            FileName = fileName,  
            ArchiveFileName = $"{log_folder}/{level.Name}_${{date:format=yyyyMMdd}}.{{#}}.txt",  
            Layout = layout,  
