...
author: msj
categories: ["【 csharpㆍdotnetㆍavalonia 】", dotnet]
tags: [csharp, dotnet, svc]
---

닷넷 코어 3.0 버전에는 **Worker Service**라 불리는 새로운 template이 추가되었다. 윈도우 서비스 프로그램을 쉽게 작성하게 해준다. 아래의 예제는 닷넷 유튜브 강좌로 유명한 [IAmTimCorey](https://www.youtube.com/channel/UC-ptWR16ITQyYOglXyQmpzw)의 강의한 내용을 소스 코드 형식으로 정리한 것이다.
