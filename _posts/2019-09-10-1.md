...
ASP.NET MVC 뷰(single view)에 여러 모델을 바인딩하는 예제이다. 하나의 Controller로 작성하여 Partial View 활용까지 6가지 정도의 방법[(WebGentle 2018)](https://www.youtube.com/watch?v=ITWZmUYnQ-s)을 기술하였다. 사용한 프레임워크는 .NET Core 3.0이다.
...
4. ViewBag
5. ViewData
6. Partial View \<partial name="_name" for="object"/\>
